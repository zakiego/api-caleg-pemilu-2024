...
const code = `const endpoint = "https://caleg.zakiego.com/api/dpd/dapil/list";
const data = await fetch(endpoint).then((res) => res.json())
console.log(data);`;

const tabs = [{ name: "index.ts", isActive: true }];
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                ...
                <Button href={SITE_CONFIG.github} variant="secondary">
                  View on GitHub
                </Button>
              </div>
            </div>
